...
# Ensure we use the correct database path (absolute path to requests.db in the same dir as this script)
database.DB_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'requests.db')
...
if __name__ == "__main__":
    try:
        print(f"Using database at: {database.DB_PATH}")
